...
export default function MobileChatPanel({ sessionId, user, participants, participantsLoading }: { sessionId: string; user: LocalUser | null, participants: Participant[], participantsLoading: boolean }) {
